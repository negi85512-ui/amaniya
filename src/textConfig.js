const textConfig = {
  landing: {
    title: "Happy Birthday, ANUSHKA KAPOOR! 🎂✨",
    subtitle: "Today is all about celebrating meri madam ji ka birthday. I've created something magical just for you on your special day...",
  ...
  letter: {
    ...
    letterHeaderTitle: "Meri jaanu ke liye",
    letterMessage: `My dearest Anshuuu,

Today marks another year of your incredible existence, and babyyyy I couldn't be more grateful to celebrate it with you.

You bring so much joy, laughter, and love into my world. You deserve all the magic, all the dreams, and all the love I have to offer. 💕`,
  ...
  cakeCutting: {
    ...
    wishInstructions: "Think of something wonderful(amaniya) for your new year!",
  ...
  cards: {
    ...
    cardMessages: [
      "Happy Birthday to the girl who makes every day feel like a celebration for me! 🎉💕",
      "Another year of being Amaniya ki baddie, beautiful, and perfect just the way you are! ✨",
  ...
  finalLetter: {
    ...
    // Letter content
    letterGreeting: "Meri jaan, jaaneman, jaanuu, monki, darling,",
    letterParagraphs: [
      "Happy birthdayyyyy jaaaaaneemannnnnnnn, I love you veryyyy veryyyyy muchhhhhh Anushkaaaaa darlingggggg. I will make sure aapkaaa 17th year baakii saaree saalo se bhi achaaaa jaayee.",
      "Anushkaaaaa you deserve all the love I give you, infact you deserve even more. Bhttt bhhtt acheee hoooo aapppp jaaaanuuuuu. kuch saalo takkk tohhh anshuuuu we cannot celebrate your birthday together lekinn anushkaa jabb bhii we will it will be a very memorable day. 🎂✨"
    ],
